...
zip_code = ['19020-PA' , '070807-NJ', '02301-MA', '76039-TX', '55330-MN', '44256-OH', '08096-NJ', '60053-IL', '94806-CA', '27909-NC', '30083-GA', '77566-TX']
cities = ['New York', 'Los Angeles', 'Chicago', 'Houston', 'Phoenix', 'Philadelphia', 'San Antonio', 'San Diego', 'Dallas', 'San Jose', 'Seattle', 'Mimia']
...
def generate_fake_data(num_entries=10):
    ...
    for _ in range(num_entries):
        entry = [
            ...
            product := random.choice(zip_code),
